...
@include('admin.contents.client._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_clients_detail')}}",
        delete: "{{route('dashboard_clients_delete')}}",
        submit: "{{route('dashboard_clients_post')}}",
        table: "{{route('dashboard_clients_table')}}"
    };
    var table;
