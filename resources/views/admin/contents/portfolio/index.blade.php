...
@include('admin.contents.portfolio._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_portfolios_detail')}}",
        delete: "{{route('dashboard_portfolios_delete')}}",
        submit: "{{route('dashboard_portfolios_post')}}",
        table: "{{route('dashboard_portfolios_table')}}"
    };
    var table;
