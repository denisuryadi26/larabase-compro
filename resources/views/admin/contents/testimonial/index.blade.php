...
@include('admin.contents.testimonial._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_testimonials_detail')}}",
        delete: "{{route('dashboard_testimonials_delete')}}",
        submit: "{{route('dashboard_testimonials_post')}}",
        table: "{{route('dashboard_testimonials_table')}}"
    };
    var table;
